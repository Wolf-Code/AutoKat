...
exports.WiFi = {
    ...
    postRender: function () { return __awaiter(_this, void 0, void 0, function () {
        var data, json, html;
        var _this = this;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fetch('/wifi', {
                        method: 'GET'
                    })];
                case 1:
                    data = _a.sent();
                ...
                case 2:
                    json = (_a.sent());
                    html = '';
                    json.sort(function (a, b) { return b.strength - a.strength; });
                    ...
                    json.forEach(function (network) {
                        var element = document.getElementById("wifi-" + network.name);

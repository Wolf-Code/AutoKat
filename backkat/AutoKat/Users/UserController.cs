...
using AutoKat.Services.Users;
using Microsoft.AspNetCore.Authorization;
using Microsoft.AspNetCore.Mvc;
using System;
using System.Threading.Tasks;

namespace AutoKat.Users
{
	...
	public class UserController : Controller
	{
		...
		[Authorize]
		[HttpGet]
		public async Task<UserInformationResponse> GetUserInformation()
		{
		...
		[HttpPost]
		[Route("login")]
		public async Task<UserLoginResponse> Login([FromBody] UserLoginRequest login)
		{
		...
		[HttpPost]
		public async Task<UserRegistrationResponse> Register([FromBody] UserRegistrationRequest newUser)
		{
